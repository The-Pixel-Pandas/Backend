...
class TransactionHistorySerializer(serializers.ModelSerializer):
    ...
    question_image_base64 = serializers.CharField(source='question.image_base64', read_only=True)
    ...
    task_image_base64 = serializers.CharField(source='task.image_base64', read_only=True)

    class Meta:
        model = TransactionHistory
        fields = [
            'transaction_id', 'question', 'question_topic', 'question_description',
            'question_image_base64', 'task', 'task_topic', 'task_description',
            'task_image_base64', 'amount', 'time', 'date', 'user', 'user_name',
            'option', 'option_description', 'transaction_type'
        ]
...
class QuestionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'updated_at', 'end_time', 'is_active', 'winning_option', 'image_base64',
